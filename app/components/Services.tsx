        ...
        <section id="services" className="py-12 bg-gray-50">
          <div className="container mx-auto px-6 lg:px-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="bg-white p-6 shadow-lg rounded-lg">
                <div className="text-center">
                  ...
                  <p className="text-gray-600">
                    Get your music on all major streaming platforms including
              ...
              <div className="bg-white p-6 shadow-lg rounded-lg">
                <div className="text-center">
                  ...
                  <p className="text-gray-600">
                    Expand your audience across Africa and worldwide with our
              ...
              <div className="bg-white p-6 shadow-lg rounded-lg">
                <div className="text-center">
                  ...
                  <p className="text-gray-600">
                    Track your streams, revenue, and audience engagement with
            ...
            <div className="mt-12 text-center">
              <a
                href="https://www.songdis.com/auth/signup"
                className="px-6 py-3 text-white bg-red-600 hover:bg-red-700 rounded-lg text-lg font-semibold"
              >
                Join Now
              </a>
            </div>
